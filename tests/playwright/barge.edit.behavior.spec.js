...
test.describe('BargeEdit - Edit Form Behavior Analysis', () => {
    let testReport = {
        testSuite: 'BargeEdit Form Behavior',
        timestamp: new Date().toISOString(),
        baseURL: 'https://localhost:6001/Barge/Edit',
        scenarios: []
    };
    ...
    test.afterAll(async () => {
        const reportPath = path.join(__dirname, '..', 'test-results', 'BargeEdit_FORM_BEHAVIOR_REPORT.md');

        let markdown = `# BargeEdit Form Behavior Report\n\n`;
    ...
    test('Scenario 1: Clear Required Field - Commodity Code', async ({ page }) => {
        ...
        const codeField = page.locator('input[name="BargeNumber"]');
        ...
        const fieldError = await page.locator('span[data-valmsg-for="BargeNumber"]').textContent().catch(() => '');
        ...
        await page.screenshot({ path: 'test-results/barge-edit-scenario1-clear-required.png', fullPage: true });
    ...
    test('Scenario 2: Clear Required Field - Commodity Name', async ({ page }) => {
        ...
        const nameField = page.locator('input[name="BargeName"]');
        ...
        const fieldError = await page.locator('span[data-valmsg-for="BargeName"]').textContent().catch(() => '');
        ...
        await page.screenshot({ path: 'test-results/barge-edit-scenario2-clear-name.png', fullPage: true });
        captureScenarioResult(scenarioName, description, inputs, observations);
    });
    ...
    test('Scenario 3: Exceed Maximum Length - Commodity Code', async ({ page }) => {
        ...
        await page.screenshot({ path: 'test-results/barge-edit-scenario3-max-length-code.png', fullPage: true });
        captureScenarioResult(scenarioName, description, inputs, observations);
    ...
    test('Scenario 4: Exceed Maximum Length - Commodity Name', async ({ page }) => {
        ...
        await page.screenshot({ path: 'test-results/barge-edit-scenario4-max-length-name.png', fullPage: true });
        captureScenarioResult(scenarioName, description, inputs, observations);
    ...
    test('Scenario 5: SQL Injection in Description Field', async ({ page }) => {
        ...
        if (await descriptionField.count() > 0) {
            ...
            await page.screenshot({ path: 'test-results/barge-edit-scenario5-sql-injection.png', fullPage: true });
            captureScenarioResult(scenarioName, description, inputs, observations);
        }
    });
    ...
    test('Scenario 6: Valid Edit - Update Description', async ({ page }) => {
        ...
        if (await descriptionField.count() > 0) {
            ...
            await page.screenshot({ path: 'test-results/barge-edit-scenario6-valid-edit.png', fullPage: true });
            captureScenarioResult(scenarioName, description, inputs, observations);
        }
    });
    ...
    test('Scenario 7: Toggle IsActive Checkbox', async ({ page }) => {
        ...
        await page.screenshot({ path: 'test-results/barge-edit-scenario7-toggle-active.png', fullPage: true });
        captureScenarioResult(scenarioName, description, inputs, observations);
